 ...
 */
final class Version20240220224030 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE company ALTER company_number SET NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE company ALTER company_number DROP NOT NULL');
    }
}
